...
import { CheckCircleTwoTone, CloseCircleTwoTone, EyeOutlined, LinkOutlined, EditOutlined, DeleteOutlined } from '@ant-design/icons';
...
const ViewForms = props => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: status => (
        status ?
            <CheckCircleTwoTone twoToneColor="#52c41a" /> : <CloseCircleTwoTone twoToneColor="#eb2f96"/>
      ),
    },
    {
